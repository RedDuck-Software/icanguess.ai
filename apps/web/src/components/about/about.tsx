  ...
  return (
    <section className="relative h-[98vh] w-full">
      ...
      <Card
        ...
        radius={50}
      >
        <div className="relative z-30 flex w-full bg-dark p-10">
        ...
        <div ref={ref} className="flex h-full w-full">
          <div className="relative z-30 flex h-full flex-1 flex-col items-center justify-center gap-20 bg-dark px-20">
            <div className="flex flex-col gap-10">
              ...
              <div className="flex flex-wrap justify-center gap-2.5">
                {numbers.map((num) => (
                  <div
                    className={cn(
                      'flex w-[200px] gap-1 rounded-[6px] px-5 py-4 font-roboto text-[20px]',
                    )}
                  >
